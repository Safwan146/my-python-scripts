...
def print_logo ():#line:7:def print_logo():
    ...
    print ("   ╔══════════════════════════════════════════════════════════════╗")#line:10:print("   ╔══════════════════════════════════════════════════════════════╗")
    print ("   ║                   CYBER PROTECTOR ARMY TOOL                      ║")#line:11:print("   ║                   CYBER PROTECTOR ARMY TOOL                      ║")
    print ("   ╚══════════════════════════════════════════════════════════════╝")#line:12:print("   ╚══════════════════════════════════════════════════════════════╝")
    print ("\n")#line:13:print("\n")
    ...
    print ("   ╠══════════════════════════════════════════════════════════════════════╣")#line:25:print("   ╠══════════════════════════════════════════════════════════════════════╣")
    print ("   ║  👤 Coded By  : Safwan Al-Sadaf                              ║")#line:26:print("   ║  👤 Coded By  : Safwan Al-Sadaf                              ║")
    print ("   ║  🖊️ Author     : Cyber Protector Army                                    ║")#line:27:print("   ║  🖊️ Author     : Cyber Protector Army                                    ║")
    print ("   ║  🔗 Facebook  : https://www.facebook.com/share/1C8AzUzFM7/      ║")#line:28:print("   ║  🔗 Facebook  : https://www.facebook.com/share/1C8AzUzFM7/      ║")
    print ("   ║  📘 Team  Page: https://www.facebook.com/share/1CsLGvjTiU/        ║")#line:29:print("   ║  📘 Team  Page: https://www.facebook.com/share/1CsLGvjTiU/         ║")
    print ("   ║  🏛️ Team  Group: https://facebook.com/groups/kabookshop/ ║")#line:30:print("   ║  🏛️ Team  Group: https://facebook.com/groups/kabookshop/ ║")
    print ("   ╠══════════════════════════════════════════════════════════════════════╣")#line:31:print("   ╠══════════════════════════════════════════════════════════════════════╣")
...
def login ():#line:37:def login():
    ...
    while O0O0OO0000OO00O00 <3 :#line:44:while attempts < 3:
        ...
        if O0000000OOO000O00 =="cyber_protector_army"and OO00OO00OO0OOO00O =="safwan1100":#line:48:if username == "cyber_protector_army" and password == "safwan1100":
            print ("\n   ✅ Login Successful!\n")#line:49:print("\n   ✅ Login Successful!\n")
